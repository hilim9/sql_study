...
- 논리 부정 연산자<br>
  ...
  대소·등가 비교 연산자에 직접 사용하는 경우는 별로 없습니다.
  하지만 복잡한 여러 개 조건식이 AND, OR로 묶여 있는 상태에서 정반대 결과를 얻고자 할 때에는 유용하게 사용할 수 있습니다.
...
- BETWEEN A AND B 연산자<br>
  특정 열 값의 최소·최고 범위를 지정하여 해당 범위 내의 데이터만 조회할 경우에<br>
